...
public static class Serialization
{
	...
	{
		public static readonly PointFormatter Instance = new();
	...
	{
		public static readonly PolygonFormatter Instance = new();
	...
	public class Resolver : IFormatterResolver
	{
		...
		{
			public static IMessagePackFormatter<T> Formatter { get; } = default!;
