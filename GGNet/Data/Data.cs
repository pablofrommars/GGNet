	...
	where TY : struct
{
	...
	public sealed class _Selectors
	{
		public Func<T, TX>? X { get; internal set; }

		public Func<T, TY>? Y { get; internal set; }
	}

	public _Selectors Selectors { get; } = new _Selectors();

	public sealed class _Positions
	{
		public class _Position<TKey>
			where TKey : struct
		{
			public Buffer<Position<TKey>> Scales { get; } = new(16, 1);

			public Func<Position<TKey>> Factory { get; internal set; } = default!;
	...
	public _Aesthetics Aesthetics { get; } = new();
	...
	public Buffer<PanelFactory> PanelFactories { get; } = new(4, 1);

	public Buffer<Panel> Panels { get; } = new(16, 1);
